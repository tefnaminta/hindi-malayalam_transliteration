...
#: as `ব`.
from hind-mal_transliteration.sanscript.schemes import Scheme
from hind-mal_transliteration.sanscript.schemes import roman
from hind-mal_transliteration.sanscript.schemes.brahmic import northern, southern
...
def transliterate(data, _from=None, _to=None, scheme_map=None, **kw):
  ...
  from hind-mal_transliteration.sanscript.brahmic_mapper import _brahmic
  from hind-mal_transliteration.sanscript.roman_mapper import _roman
